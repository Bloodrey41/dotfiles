...
from defaults import mod, mod1, mod2, home, myTerm, systemMonitor, myFM, myBrowser, jobBrowser
...
keys = [
    ...
    Key(["mod1"], "f", lazy.spawn(jobBrowser)),
    Key(["mod1", "shift"], "f", lazy.spawn(jobBrowser + ' --private-window')),
