...
function olc
    ...
    set -lx ANTHROPIC_DEFAULT_SONNET_MODEL "deepseek-v4-pro:0813-cloud[1m]"
    set -lx ANTHROPIC_DEFAULT_SONNET_MODEL_NAME "DeepSeek V4 Pro"
    set -lx ANTHROPIC_DEFAULT_HAIKU_MODEL "minimax-m3:cloud"
    set -lx ANTHROPIC_DEFAULT_HAIKU_MODEL_NAME "MiniMax M3"

    set -lx CLAUDE_CODE_SUBAGENT_MODEL "deepseek-v4-pro:0813-cloud"
