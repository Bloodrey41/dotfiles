...
from defaults import mod, mod1, mod2, home, myTerm, systemMonitor, myFM, myBrowser, workBrowser
...
keys = [
    ...
    Key(["mod1"], "f", lazy.spawn(workBrowser)),
    Key(["mod1", "shift"], "f", lazy.spawn(workBrowser + ' --private-window')),
    Key(["mod1"], "b", lazy.spawn(myBrowser)),
    Key(["mod1", "shift"], "b", lazy.spawn(myBrowser + ' --incognito')),
